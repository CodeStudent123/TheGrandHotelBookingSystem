        ...
        <table class="table table-striped table-bordered">
            ...
            if ($result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <a href='edit-user.php?id=" . $row['id'] . "' class='btn btn-sm btn-primary'>Edit User</a>
                            <a href='edit-password.php?id=" . $row['id'] . "' class='btn btn-sm btn-primary'>Edit Password</a>
